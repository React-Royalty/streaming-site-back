...
const { createMedia, updateMedia, getAllMedia, getMediaById, getMediaByTitle } = require("./media");
...
async function testDB() {
  ...
  console.log("getMediaById(1) ->");
  console.log(await getMediaById(1));
  console.log("getMediaByTitle(Survivor) ->");
  console.log(await getMediaByTitle("Survivor"));
  // await attachCategoriesToMedia(); ???
